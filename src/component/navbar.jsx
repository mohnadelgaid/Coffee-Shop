...
const Navbar = () => {
    let [nav,setNav] = useState("0px");
    let [back,backtNav] = useState("inherit");
        ...
        <div className='fixed w-full mb-5 z-50'>
                ...
                <div className='container'>
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='text-titleColor text-2xl md:hidden'>
                            <Link onClick={()=> nav==='200px'?setNav("0px"):setNav("200px")}>
            ...
            <div>
                <div className='container md:hidden'>
                    ...
                    font-bodyFont text-titleColor list-none flex flex-col md:hidden gap-4" style={{height : `${nav}`}}>
